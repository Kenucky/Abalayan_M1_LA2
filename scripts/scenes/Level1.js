class Level1 extends Phaser.Scene {
    ...
    create() {
        this.add.image(400, 300, 'bg1').setScale(2);
        this.add.image(400, 300, 'bg2').setScale(2);
        this.add.image(400, 300, 'bg3').setScale(2);
        this.add.image(400, 300, 'bg4').setScale(2);
        ...
        this.levelText = this.add.text(0, 16, 'Level 1', { fontSize: '24px', fill: '#000' });
...
var gameOver = false;
var scoreText;
const rainbowColors = [0xff0000, 0xffa500, 0xffff00, 0x00ff00, 0x0000ff, 0x4b0082, 0xee82ee];
let colorIndex = 0;
let playerScale = 1;
